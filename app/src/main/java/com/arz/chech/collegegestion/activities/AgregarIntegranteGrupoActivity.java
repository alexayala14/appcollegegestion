...
public class AgregarIntegranteGrupoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_agregar_integrante_grupo);
        /*<ProgressBar
                    ...
                    if (snapshot.child("estaEliminado").exists()) {
                        if (!mCurrent_user_id.equals(usuario.getToken())) {
                            if (!usuario.isEstaEliminado()) {
                                ...
                                if ((String.valueOf(Preferences.obtenerPreferenceInt(AgregarIntegranteGrupoActivity.this, Preferences.PREFERENCE_ESTADO_ID_PERFIL)).equals("1"))) {

                                    datosUsuarios.add(usuario);

                                }

                                if ((String.valueOf(Preferences.obtenerPreferenceInt(AgregarIntegranteGrupoActivity.this, Preferences.PREFERENCE_ESTADO_ID_PERFIL)).equals("2"))) {
                                    if (usuario.getPerfil().equals("1") || usuario.getPerfil().equals("2") || usuario.getPerfil().equals("3")) {
                                        datosUsuarios.add(usuario);
                                    }
                                }

                                if ((String.valueOf(Preferences.obtenerPreferenceInt(AgregarIntegranteGrupoActivity.this, Preferences.PREFERENCE_ESTADO_ID_PERFIL)).equals("3"))) {
