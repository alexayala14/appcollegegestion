       ...
       vista=inflater.inflate(R.layout.fragment_mis_publicaciones, container, false);
        ...
        adapter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Bundle b = new Bundle();
                b.putString("descripcion",listaPublicaciones.get(recyclerViewMisPublicaciones.getChildAdapterPosition(view)).getDescripcion()+"\n");
                b.putString ("detalle", listaPublicaciones.get(recyclerViewMisPublicaciones.getChildAdapterPosition(view)).getDetalle());
